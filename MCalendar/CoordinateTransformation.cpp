...
History: PJN / 14-02-2004 1. Fixed a "minus zero" bug in the function CoordinateTransformation::DMSToDegrees.
...
CAA2DCoordinate CoordinateTransformation::Equatorial2Ecliptic(double Alpha, double Delta, double Epsilon)
{
...
CAA2DCoordinate CoordinateTransformation::Ecliptic2Equatorial(double Lambda, double Beta, double Epsilon)
{
...
CAA2DCoordinate CoordinateTransformation::Equatorial2Horizontal(double LocalHourAngle, double Delta, double Latitude)
{
...
CAA2DCoordinate CoordinateTransformation::Horizontal2Equatorial(double Azimuth, double Altitude, double Latitude)
{
...
CAA2DCoordinate CoordinateTransformation::Equatorial2Galactic(double Alpha, double Delta)
{
...
CAA2DCoordinate CoordinateTransformation::Galactic2Equatorial(double l, double b)
{
  l -= 123;
...
double CoordinateTransformation::DMSToDegrees(double Degrees, double Minutes, double Seconds, bool bPositive)
{
